...
if (swipe_choice == 1 || swipe_choice == "right" || swipe_choice =="Right") {
...
if (food_choice == 1 || food_choice == "Italian"){
alert("Ah, molto bella!");
}else if (food_choice == 2 || food_choice == "Curry") {
...
if (age_guess < 30 || age_guess === true){
...
if ((pay_choice == 2 || pay_choice == ")Offer to pay.") && money_in_wallet >= 100){
